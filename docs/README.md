...
2. [🧩 Introduction to ReVanced Patches](2_patches_intro)
   1. [👨‍💻 Setting up a development environment](2_1_setup)
   2. [🧩 Anatomy of a ReVanced patch](2_2_patch_anatomy)
      1. [🔎 Fingerprinting](2_2_1_fingerprinting.md)
   3. [📜 Project structure and conventions](3_structure_and_conventions.md)
   4. [💪 Advanced APIs](4_apis)
